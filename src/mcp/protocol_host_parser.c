...
#include <string.h>
    ...
    static void default_ack_callback(Ack ack, void *user_data)
    {
        (void)ack;
        (void)user_data;
    }
    static void default_error_callback(uint32_t error, void *user_data)
    {
        (void)error;
        (void)user_data;
    }
    static void default_datafloat_callback(FloatData fd, void *user_data)
    {
        (void)fd;
        (void)user_data;
    }
    static void default_reply_callback(Reply reply, void *user_data)
    {
        (void)reply;
        (void)user_data;
    }
    static void default_respiration_callback(RespirationData rd, void *user_data)
    {
        (void)rd;
        (void)user_data;
    }
    ...
    static void default_baseband_ap_callback(BasebandApData bap, void *user_data)
    {
        (void)bap;
        (void)user_data;
    }
    static void default_baseband_iq_callback(BasebandIqData bap, void *user_data)
    {
        (void)bap;
        (void)user_data;
    }
    static void default_presence_single(PresenceSingleData tps, void *user_data)
    {
        (void)tps;
        (void)user_data;
    }
    static void default_presence_movinglist(PresenceMovingListData tpml, void *user_data)
    {
        (void)tpml;
        (void)user_data;
    }
    static void default_system_status(SystemStatus ss, void *user_data)
    {
        (void)ss;
        (void)user_data;
    }
